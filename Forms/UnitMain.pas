...
{*
  Из-за сломанной механики ListBox, мы храним указатель на структуру в тексте элемента списка. ќбъект добавл¤етс¤ к элементу отдельно, а не сразу из-за чего часть сообщений от системы
